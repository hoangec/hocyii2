...
Class ValueHelpers{
	...
	*/
	public static function getRoleNameValue($role_name){
	...
	*/
	public static function getStatusNameValue($status_name){
		$connection = \Yii::$app->db;
		$sql = "SELECT status_value FROM status WHERE status_name = :staus_name";
		$command = $connection->createCommand($sql);
		$command->bindValue(':staus_name',$status_name);
		$result = $command->queryOne();
