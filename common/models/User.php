...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
           ...
           // ['user_type_id', 'range', 'in' => array_keys($this->getUserTypeList())],
            //
    ...
    public function attributeLabels(){
        return [
            'roleName' => Yii::t('frontend','Role'),
            'statusName' => Yii::t('frontend', 'Status'),
            'profileId' => Yii::t('frontend', 'Profile'),
            'profileLink' => Yii::t('frontend', 'Profile'),
            'userLink' => Yii::t('frontend', 'User'),
            'username' => Yii::t('frontend', 'User'),
            'userTypeName' => Yii::t('frontend', 'User Type'),
            'userTypeId' => Yii::t('frontend', 'User Type'),
            'userIdLink' => Yii::t('frontend', 'ID'),
        ];
    }
